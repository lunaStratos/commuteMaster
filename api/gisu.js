  ...
  function gisuRequest(requestType, callback) {
    ...
    switch (requestType) {
      case 'foodDecay': // 식중독지수
        url = "http://newsky2.kma.go.kr/iros/RetrieveLifeIndexService3/getFsnLifeList?serviceKey=" + api.api + "&areaNo=1100000000";
        break;

      case 'bul': // 불쾌지수.(제공기간:6월~9월)
        url = "http://newsky2.kma.go.kr/iros/RetrieveLifeIndexService3/getDsplsLifeList?serviceKey=" + api.api + "&areaNo=1100000000";
      ...
      case 'chegam': // 체감온도 11~3월
        url = "http://newsky2.kma.go.kr/iros/RetrieveLifeIndexService3/getSensorytemLifeList?serviceKey=" + api.api + "&areaNo=1100000000";
        //http://newsky2.kma.go.kr/service/SecndSrtpdFrcstInfoService2/ForecastTimeData?serviceKey=" + api.api + "&base_date=20181026&base_time=1500&nx=60&ny=127&numOfRows=100&pageSize=10&pageNo=1&startPage=1&_type=json

        break;
      case 'uv': // 자외선지수(제공기간:3월~11월)
        url = "http://newsky2.kma.go.kr/iros/RetrieveLifeIndexService3/getUltrvLifeList?serviceKey=" + api.api + "&areaNo=1100000000";
        //http://newsky2.kma.go.kr/service/SecndSrtpdFrcstInfoService2/ForecastTimeData?serviceKey=" + api.api + "&base_date=20181026&base_time=1500&nx=60&ny=127&numOfRows=100&pageSize=10&pageNo=1&startPage=1&_type=json
      ...
      case 'virus1': // 질병예방 : 감기와 눈병만 한다
        url = 'http://apis.data.go.kr/B550928/dissForecastInfoSvc/getDissForecastInfo?serviceKey=' + api.api;
        forms = {
      ...
      case 'mise': // 질병예방 : 감기와 눈병만 한다
        url = 'http://openapi.airkorea.or.kr/openapi/services/rest/ArpltnInforInqireSvc/getMinuDustFrcstDspth?serviceKey='+ api.api;
