...
exports.insertFirstApi = (knex, requestType, insertData) => {
  ...
  function weatherRequest(insertData, requestType, callback) {
    ...
    switch (requestType) {
      case 'nowWeather': // 실황
        url = "http://newsky2.kma.go.kr/service/SecndSrtpdFrcstInfoService2/ForecastGrib?serviceKey="+api.api;
        //http://newsky2.kma.go.kr/service/SecndSrtpdFrcstInfoService2/ForecastGrib?serviceKey="+api.api+"&base_date=20181026&base_time=1500&nx=60&ny=127&numOfRows=8&pageSize=1&pageNo=1&startPage=1&_type=json
      ...
      case 'forecastShortWeather': //초단기예보 3시간치
        url = "http://newsky2.kma.go.kr/service/SecndSrtpdFrcstInfoService2/ForecastTimeData?serviceKey="+api.api;
        //http://newsky2.kma.go.kr/service/SecndSrtpdFrcstInfoService2/ForecastTimeData?serviceKey="+api.api+"&base_date=20181026&base_time=1500&nx=60&ny=127&numOfRows=100&pageSize=10&pageNo=1&startPage=1&_type=json
      ...
      case 'forecastWeather': //동네예보 하루치
        url = "http://newsky2.kma.go.kr/service/SecndSrtpdFrcstInfoService2/ForecastSpaceData?serviceKey="+api.api;
        //http://newsky2.kma.go.kr/service/SecndSrtpdFrcstInfoService2/ForecastSpaceData?serviceKey="+api.api+"&base_date=20181026&base_time=1500&nx=60&ny=127&numOfRows=100&pageSize=1&pageNo=1&startPage=1&_type=json
        //  pop강수확률
        //  pty 강수형태
        //  T3H 3시간 기온
        // S06 신적설
